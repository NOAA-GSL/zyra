...
from datavizhub.api.workers.executor import RunResult, _maybe_copy_output, _ensure_results_dir
...
def test_binary_stdout_saved_with_extension(tmp_path: Path) -> None:
    ...
    rr = RunResult(stdout='', stderr='', exit_code=0, stdout_bytes=b"\x89PNG\r\n\x1a\n...", stderr_bytes=b"")
