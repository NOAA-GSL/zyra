...
def test_stac_capabilities_collection_offline():
    ...
    out = enrich_items([item], level="capabilities", timeout=1.0, workers=1, cache_ttl=10, offline=True)
    ...
    assert t is not None and t.start == "2020-01-01T00:00:00Z" and t.end == "2021-01-01T00:00:00Z"
