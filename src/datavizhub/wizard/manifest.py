...
def _safe_register_all(sub: argparse._SubParsersAction) -> None:
    ...
    _safe_add_group(
        ...
        dest="acquire_cmd",
        import_path="datavizhub.connectors.ingest",
    )
    ...
    _safe_add_group(
        ...
        dest="process_cmd",
        import_path="datavizhub.processing",
    )
    ...
    _safe_add_group(
        ...
        dest="visualize_cmd",
        import_path="datavizhub.visualization.cli_register",
    )
    ...
    _safe_add_group(
        ...
        dest="decimate_cmd",
        import_path="datavizhub.connectors.egress",
    )
    ...
    _safe_add_group(
        ...
        dest="transform_cmd",
        import_path="datavizhub.transform",
    )

    # run
    _safe_call_register(
        sub, import_path="datavizhub.pipeline_runner", func_name="register_cli_run"
    )
